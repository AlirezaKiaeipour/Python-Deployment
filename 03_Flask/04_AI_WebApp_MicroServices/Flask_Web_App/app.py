...
face_analysis_microservice = "http://127.0.0.1:8000/face-analyze"
object_detection_microservice = "http://127.0.0.1:5000/object-detection"
        ...
        if request.method == "GET":
            ...
            try:
                ...
                if image.filename == "":
                    ...
                    if image and allowed_file(image.filename):
                        result = requests.post(face_analysis_microservice, files={"file":image})
                        result = result.json()
            ...
            try:
                ...
                if image.filename == "":
                    ...
                    if image and allowed_file(image.filename):
                        result = requests.post(object_detection_microservice, files={"file":image})
                        result = result.json()
